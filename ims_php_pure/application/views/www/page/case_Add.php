        ...
        <div id="content" class="width">
            ...
            <div class="addNewProblemForm">
                <div class="info">
                    ...
                    <div class="infoLine">
                        <span>案例题目：</span><textarea name="title" rows="5" class="form-control Long"></textarea>
                    </div>
                    <div class="infoLine">
                        <span>案例概要：</span><textarea name="abstract" rows="5" class="form-control Long"></textarea>
                    </div>
                    <div class="infoLine middleWide"></div>
                    <div class="infoLine">
                        <span>案例描述：</span><textarea name="description" rows="5" class="form-control Long"></textarea>
                    </div>
                    
                    <div  class="infoLine">
                        <span>解题过程：</span><textarea name="course" rows="5" class="form-control Long"></textarea>
                    </div>
                    <div class="infoLine  middleWide">
                        <span>概念方案：</span><textarea name="conceptSolution" rows="5" class="form-control Long"></textarea>
                    </div>
                    <div class="infoLine">
                        <span>采用方案：</span><textarea name="solutionEmployed" rows="5" class="form-control Long"></textarea>
                    </div>
                    
                    <div class="infoLine middleWide">
                        <span>方案实现：</span><textarea name="solutionImplementation" rows="5" class="form-control Long"></textarea>
                    </div>
